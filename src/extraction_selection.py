...
def choose_extraction_candidate(
    ...
    if not original.success and corrected.success:
        ...
        return ExtractionSelection(corrected, original, corrected, "corrected", reason, rgb_difference, lab_difference, chroma_preservation)
    if original.success and not corrected.success:
        ...
        return ExtractionSelection(original, original, corrected, "original", reason, rgb_difference, lab_difference, chroma_preservation)
    ...
    if high_quality_lighting and not correction_improves:
        reason = "Original image color was preserved because correction did not improve extraction reliability."
        return ExtractionSelection(original, original, corrected, "original", reason, rgb_difference, lab_difference, chroma_preservation)
...
def run_dual_extraction(
    ...
    return choose_extraction_candidate(original_result, corrected_result, lighting_quality)
